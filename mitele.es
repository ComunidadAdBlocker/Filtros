...
@@||imasdk.googleapis.com/js/sdkloader/$script,domain=mitele.es
@@*$xmlhttprequest,domain=mitele.es
@@||mdsrwdassets-a.akamaihd.net^$script,domain=mitele.es
...
@@/nonAdBlock/*ad$script
@@||mdsrwdassets-a.akamaihd.net/*ad$xmlhttprequest
||mitele.es/vendor/v4-akamai-plugin.js
